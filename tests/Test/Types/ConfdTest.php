...
{
    /** @test */
    public function attributes_are_available_to_templates(): void
    {
    ...
    /** @test */
    public function functions_are_available_to_templates(): void
    {
    ...
    /** @test */
    public function template_src_is_suffixed_with_the_twig_extension(): void
    {
...
EOD
    ...
    /** @test */
    public function template_dst_when_not_specified_is_placed_in_the_same_location_as_src_without_the_twig_file_extension(): void
    {
        $path = $this->workspaceWithSampleData(<<<'EOD'
confd('workspace:/'):
  - { src: sample1.txt }
...
EOD
    ...
    /** @test */
    public function whether_a_template_is_applied_or_not_can_be_controlled_with_a_conditional_expression(): void
    {
        $path = $this->workspaceWithSampleData(<<<'EOD'
confd('workspace:/'):
...
EOD
    ...
    /** @test */
    public function when_only_a_string_is_specified_it_is_treated_as_the_src_with_defaults_applied_to_the_other_attributes(): void
    {
