...
{
    /** @test */
    public function helper_can_access_attributes_using_array_access_interface(): void
    {
...
EOD
    ...
    /** @test */
    public function helper_can_call_dynamically_declared_functions(): void
    {
        $this->createWorkspaceYml(
            <<<'EOD'
...
EOD
    ...
    /** @test */
    public function helper_can_run_declared_commands(): void
    {
        $this->createWorkspaceYml(
            <<<'EOD'
command('cmdA'): |
